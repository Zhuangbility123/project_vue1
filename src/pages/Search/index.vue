  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <!-- trademarkInfo自定义事件名 callbacktrademarkInfo回调函数名 -->
        <SearchSelector @trademarkInfo = "callbacktrademarkInfo" @attrInfo = "attrInfo" />
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a href="#">综合 <span v-if="isOne&&isDesc">⬇</span><span v-if="isOne&&(!isDesc)">↑</span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a href="#">价格 <span v-if="isTwo&&isDesc">⬇</span><span v-if="isTwo&&(!isDesc)">↑</span></a>
                </li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    callbacktrademarkInfo(trademark) {
    ...
    changeOrder(flag) {
      ...
      let newOrder = ''
      if (flag == originFlag) {
        newOrder = `${originFlag}:${originSort=='desc'? 'esc':'desc'}`
      } else {
        newOrder =`${flag}:${'desc'}`
      }
